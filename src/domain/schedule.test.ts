...
describe('schedule', () => {
  ...
  it('reschedule cascades following slots', () => {
    ...
    const moved = rescheduleWorkout(schedule, 1, '2026-08-07', '2026-08-01', null)
  ...
  it('rejects reschedule within 48h of previous slot', () => {
    ...
    expect(rescheduleWorkout(schedule, 1, '2026-08-04', '2026-08-01', null)).toBeNull()
  })

  it('rejects reschedule within 48h of lastWorkoutDate for slot 0', () => {
    const schedule = [{ date: '2026-08-06', stepRef: 2 }]
    expect(rescheduleWorkout(schedule, 0, '2026-08-05', '2026-08-05', '2026-08-04')).toBeNull()
  })

  it('allows early start to today when lastWorkoutDate gap is sufficient', () => {
    const schedule = [{ date: '2026-08-08', stepRef: 2 }]
    expect(canStartEarly(schedule, 0, '2026-08-06', '2026-08-03')).toBe(true)
    expect(rescheduleWorkout(schedule, 0, '2026-08-06', '2026-08-06', '2026-08-03')).not.toBeNull()
  })
  ...
  it('rejects reschedule to a past date', () => {
    ...
    expect(rescheduleWorkout(schedule, 1, '2026-08-14', '2026-08-16', null)).toBeNull()
  })
  ...
  it('getRescheduleOptions excludes past dates and dates within 48h of lastWorkout', () => {
    ...
    const options = getRescheduleOptions(schedule, 1, '2026-08-16', null)
