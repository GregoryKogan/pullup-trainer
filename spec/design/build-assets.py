...
PALETTES = [
    P(slug="p01-volt", num="P01", name="Volt", style="эталонный неон-зелёный",
      ...
      dark=P(bg="#0E0E0B", bg2="#070706", card="#161612", ink="#F7F7F0", muted="#A3A397",
            line="#000000", accent="#C6FF3B", accent_text="#C6FF3B", accent_ink="#0E0E0B", accent2="#FFD22E",
            ok="#4CE08A", warn="#FFC24D", bad="#FF5D4D", shadow="#000000"),
      light=P(bg="#F4F2EA", bg2="#E4E1D5", card="#FFFFFF", ink="#17150E", muted="#646257",
             line="#0F0E0A", accent="#A8D920", accent_text="#526A10", accent_ink="#101A02", accent2="#C79200",
    ...
    P(slug="p02-signal-orange", num="P02", name="Signal Orange", style="сигнально-оранжевый",
      ...
      dark=P(bg="#0D0A08", bg2="#070503", card="#17120E", ink="#FBF4EC", muted="#A39488",
            line="#1C1206", accent="#FF5A1F", accent_text="#FF5A1F", accent_ink="#160700", accent2="#FFB35C",
            ok="#54D98C", warn="#FFC14D", bad="#FF6D5C", shadow="#000000"),
      light=P(bg="#FAF3E9", bg2="#EBDDC9", card="#FFFDF9", ink="#1D140B", muted="#6B5F52",
             line="#241608", accent="#FF6A2E", accent_text="#B33300", accent_ink="#1A0800", accent2="#B35500",
    ...
    P(slug="p03-cobalt", num="P03", name="Cobalt", style="электрик-синий",
      ...
      dark=P(bg="#07090F", bg2="#04050A", card="#0F1220", ink="#EEF1FF", muted="#8F97B8",
            line="#0C1030", accent="#4D8DFF", accent_text="#4D8DFF", accent_ink="#041030", accent2="#7DD3FF",
            ok="#54E09B", warn="#FFC65C", bad="#FF6F7D", shadow="#000000"),
      light=P(bg="#F2F4FB", bg2="#E0E6F5", card="#FFFFFF", ink="#141832", muted="#5B6489",
             line="#10173A", accent="#6F9DFF", accent_text="#0152FF", accent_ink="#051138", accent2="#0A7ABF",
    ...
    P(slug="p04-magenta-pop", num="P04", name="Magenta Pop", style="неоновая магента",
      ...
      dark=P(bg="#0E0710", bg2="#080409", card="#170C1A", ink="#F9EDF8", muted="#A78BA6",
            line="#1F0518", accent="#FF2D95", accent_text="#FF2D95", accent_ink="#1A0010", accent2="#9D6BFF",
            ok="#54E09B", warn="#FFC65C", bad="#FF6D6D", shadow="#000000"),
      light=P(bg="#FBF1F8", bg2="#EFDFEA", card="#FFFDFE", ink="#261020", muted="#725D70",
             line="#2B0A20", accent="#F25CAE", accent_text="#BF0F6F", accent_ink="#2B0016", accent2="#6B3FD1",
    ...
    P(slug="p05-taxi", num="P05", name="Taxi", style="такси-жёлтый",
      ...
      dark=P(bg="#0D0C08", bg2="#060604", card="#16150F", ink="#F7F3E2", muted="#A29C83",
            line="#000000", accent="#FFD400", accent_text="#FFD400", accent_ink="#141000", accent2="#FF7A00",
            ok="#4CE08A", warn="#FFD35E", bad="#FF5D4D", shadow="#000000"),
      light=P(bg="#F7F4E6", bg2="#EAE5CE", card="#FFFEF8", ink="#1C1908", muted="#68644E",
             line="#151300", accent="#D4B000", accent_text="#766200", accent_ink="#141000", accent2="#D96A00",
    ...
    P(slug="p06-paper-red", num="P06", name="Paper Red", style="швейцарский ч/б + красный",
      ...
      dark=P(bg="#0A0A0A", bg2="#030303", card="#141414", ink="#F2F2F2", muted="#9A9A9A",
            line="#000000", accent="#EF4A3F", accent_text="#EF4A3F", accent_ink="#140000", accent2="#D8D8D8",
            ok="#4CD78A", warn="#FFC14D", bad="#FF5D4D", shadow="#000000"),
      light=P(bg="#FFFFFF", bg2="#E9E9E9", card="#FFFFFF", ink="#111111", muted="#676767",
             line="#111111", accent="#C6281C", accent_text="#C6281C", accent_ink="#FFFFFF", accent2="#5A5A5A",
    ...
    P(slug="p07-mint-terminal", num="P07", name="Mint Terminal", style="мятный терминал",
      ...
      dark=P(bg="#07120E", bg2="#030A07", card="#0D1C16", ink="#E9F7EF", muted="#8AA897",
            line="#032318", accent="#6FE3C1", accent_text="#6FE3C1", accent_ink="#032318", accent2="#9EE8FF",
            ok="#54E09B", warn="#FFC65C", bad="#FF6F7D", shadow="#000000"),
      light=P(bg="#EEF8F1", bg2="#DCEFE2", card="#FFFFFF", ink="#0D2118", muted="#546D62",
             line="#0A2C1E", accent="#37B389", accent_text="#247559", accent_ink="#062A1D", accent2="#0A6EA8",
    ...
    P(slug="p08-amber", num="P08", name="Amber", style="янтарный / строительный",
      ...
      dark=P(bg="#100C05", bg2="#080602", card="#1A140A", ink="#FAF3E3", muted="#A3947C",
            line="#1F1503", accent="#FFB000", accent_text="#FFB000", accent_ink="#1C1100", accent2="#FF8A3D",
            ok="#54D98C", warn="#FFD35E", bad="#FF5D4D", shadow="#000000"),
      light=P(bg="#FAF3E4", bg2="#ECE1C8", card="#FFFCF5", ink="#211806", muted="#6F6149",
             line="#2B1E04", accent="#E08A00", accent_text="#8C5600", accent_ink="#1A0F00", accent2="#C4501A",
    ...
    P(slug="p09-cyan-future", num="P09", name="Cyan Future", style="циановое будущее",
      ...
      dark=P(bg="#041114", bg2="#02080A", card="#081C20", ink="#E4F8F9", muted="#7FA8AD",
            line="#03313A", accent="#00E0E8", accent_text="#00E0E8", accent_ink="#00262C", accent2="#FF5CD0",
            ok="#54E09B", warn="#FFC65C", bad="#FF6F7D", shadow="#000000"),
      light=P(bg="#EEF8F9", bg2="#DCEFF1", card="#FFFFFF", ink="#0B262B", muted="#516D71",
             line="#093540", accent="#0FBCC4", accent_text="#097378", accent_ink="#02262B", accent2="#B01C8F",
    ...
    P(slug="p10-crimson", num="P10", name="Crimson", style="тёмно-красный",
      ...
      dark=P(bg="#0F0707", bg2="#080303", card="#180C0C", ink="#F9ECEC", muted="#A58A8A",
            line="#200404", accent="#FF4A3D", accent_text="#FF4A3D", accent_ink="#1A0000", accent2="#FF8A75",
            ok="#54E09B", warn="#FFC65C", bad="#FF7A5C", shadow="#000000"),
      light=P(bg="#FBF1F0", bg2="#EFDDDB", card="#FFFDFC", ink="#271010", muted="#755C5A",
             line="#2E0B0A", accent="#C6281C", accent_text="#BD261B", accent_ink="#FFFFFF", accent2="#A04A3D",
    ...
    P(slug="p11-spring-green", num="P11", name="Spring Green", style="весенний зелёный",
      ...
      dark=P(bg="#071208", bg2="#030903", card="#0D1B0E", ink="#EEF8EA", muted="#93A88D",
            line="#062508", accent="#00E07F", accent_text="#00E07F", accent_ink="#04260F", accent2="#6AE0FF",
            ok="#4FE3D6", warn="#FFC65C", bad="#FF6F7D", shadow="#000000"),
      light=P(bg="#F0F9EC", bg2="#DFEEDA", card="#FFFFFF", ink="#0E2412", muted="#546E56",
             line="#0C2B0F", accent="#0DAF5E", accent_text="#097841", accent_ink="#052610", accent2="#0A7FA8",
             ok="#0E7A7A", warn="#96630A", bad="#B33136", shadow="#0C2B0F")),
    P(slug="p12-ultraviolet", num="P12", name="Ultraviolet", style="фиолетовый",
      ...
      dark=P(bg="#0C0913", bg2="#06040B", card="#150F22", ink="#F1EBFB", muted="#9C8FBE",
            line="#180739", accent="#8B5CFF", accent_text="#8B5CFF", accent_ink="#12002B", accent2="#FF5CD0",
            ok="#54E09B", warn="#FFC65C", bad="#FF6F7D", shadow="#000000"),
      light=P(bg="#F5F1FC", bg2="#E7DFF5", card="#FFFFFF", ink="#1C122E", muted="#695E81",
             line="#221148", accent="#6F42D9", accent_text="#6F42D9", accent_ink="#FFFFFF", accent2="#A6247F",
    ...
    P(slug="p13-coral-sunrise", num="P13", name="Coral Sunrise", style="коралловый рассвет",
      ...
      dark=P(bg="#100A07", bg2="#080502", card="#191109", ink="#FBF1E9", muted="#A69487",
            line="#210B03", accent="#FF6B4A", accent_text="#FF6B4A", accent_ink="#220500", accent2="#6FD3FF",
            ok="#54E09B", warn="#FFC65C", bad="#FF5D7D", shadow="#000000"),
      light=P(bg="#FBF1EB", bg2="#F0DFD4", card="#FFFDFB", ink="#26140C", muted="#715F54",
             line="#2E1508", accent="#F2683F", accent_text="#B7330C", accent_ink="#220500", accent2="#1F8FC4",
    ...
    P(slug="p14-mono-ink", num="P14", name="Mono Ink", style="чистая инверсия ч/б",
      ...
      dark=P(bg="#000000", bg2="#000000", card="#0C0C0C", ink="#F5F5F5", muted="#9A9A9A",
            line="#FFFFFF", accent="#FFFFFF", accent_text="#FFFFFF", accent_ink="#000000", accent2="#A8A8A8",
            ok="#7EE8A8", warn="#E8D27E", bad="#FF8A80", shadow="#FFFFFF"),
      light=P(bg="#FFFFFF", bg2="#E9E9E9", card="#FFFFFF", ink="#111111", muted="#666666",
             line="#0F0F0F", accent="#0F0F0F", accent_text="#0F0F0F", accent_ink="#FFFFFF", accent2="#666666",
...
def build_tokens():
    token_order = ["bg", "bg2", "card", "ink", "muted", "line", "accent",
                   "accent-ink", "accent-text", "accent2", "ok", "warn", "bad", "shadow"]
